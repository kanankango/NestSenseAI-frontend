        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-6">
            <Button variant="ghost" asChild>
              <Link href="/resources/nutrition-exercise" className="flex items-center text-muted-foreground hover:text-foreground">
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle>
                <GradientText>Create Your Custom Plan</GradientText>
              </CardTitle>
