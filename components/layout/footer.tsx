      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">Your trusted companion for postpartum wellness and mental health support.</p>
            <div className="flex gap-4">
              <a href="#" className="text-[#7b68ee] hover:text-[#6a5acd]" aria-label="Follow us on Twitter">
              ...
              <a href="#" className="text-[#7b68ee] hover:text-[#6a5acd]" aria-label="Follow us on Instagram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <a href="#" className="text-[#7b68ee] hover:text-[#6a5acd]" aria-label="Follow us on LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Features", "Our Mission", "Benefits"].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase().replace(" ", "-")}`} className="text-gray-600 hover:text-[#7b68ee]">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Blog", "Support Center", "Community"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-600 hover:text-[#7b68ee]">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-8 mt-8 border-t border-gray-200 text-center text-gray-600 text-sm">
          ...
          <div className="flex justify-center gap-6 mt-4">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
              <a key={item} href="#" className="hover:text-[#7b68ee]">
                {item}
              </a>
            ))}
          </div>
