        ...
        <div className="relative z-10 p-4 md:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
              ...
              <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 border border-[#765133]/10">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <div className="p-3 rounded-full bg-gradient-to-br from-[#765133] to-[#8b6f47]">
                      <svg
                    ...
                    <CardTitle className="text-[#765133]">Meal Recommendations</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 mb-6">
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-[#765133]"></span>
                ...
                <CardFooter>
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-[#765133] to-[#8b6f47] hover:from-[#8b6f47] hover:to-[#a0845c] text-white transition-all duration-300"
                  >
                    Get Meal Ideas
                  </Button>
                </CardFooter>
              ...
              <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 border border-[#765133]/10">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <CardTitle className="text-[#765133]">Exercise Recommendations</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-6">
